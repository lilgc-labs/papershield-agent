...
class DeploymentReadinessTests(unittest.TestCase):
    def test_docker_assets_define_fastapi_demo_service(self):
        ...
        self.assertIn('PAPERSHIELD_LLM_PROVIDER\n        value: openai-compatible', render_text)
        self.assertIn("PAPERSHIELD_LLM_BASE_URL", render_text)
        self.assertIn("PAPERSHIELD_LLM_MODEL", render_text)
        self.assertIn("PAPERSHIELD_API_KEY", render_text)
        ...
        self.assertIn("PAPERSHIELD_LLM_TIMEOUT", render_text)
        self.assertIn('PAPERSHIELD_LLM_TIMEOUT\n        value: "20"', render_text)
        self.assertIn("PAPERSHIELD_LLM_MAX_RETRIES", render_text)
        self.assertIn('PAPERSHIELD_LLM_MAX_RETRIES\n        value: "0"', render_text)
